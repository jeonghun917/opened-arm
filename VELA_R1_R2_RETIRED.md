...
Status: **RETIRED / NONAUTHORITATIVE**  
Effective: 2026-09-15

All VELA R1 and R2 experiments, benchmarks, results, implementation candidates, problem packs, and product-transition claims are historical records only.

- Do not reuse R1/R2 code or problem packs.
- Do not dispatch or rerun R1/R2 workflows.
- Do not inherit prior COMPLETE, SUCCESS, MIXED, or NOT_SUPPORTED labels.
