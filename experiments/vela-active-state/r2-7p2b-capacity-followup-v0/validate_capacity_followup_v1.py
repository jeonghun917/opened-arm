...
def main():
  ...
  contract=json.loads((HERE/'CAPACITY_FOLLOWUP_CONTRACT_V1.json').read_text()); auth=json.loads((HERE/'RUNPOD_SCIENCE_MATRIX_AUTH_V1.json').read_text())
  ...
  science=(HERE/'science_common.py').read_text(); agg=(HERE/'aggregate.py').read_text(); launcher=(HERE/'runpod_science_condition_launch_v5.py').read_text()
